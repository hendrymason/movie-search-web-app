...
namespace Hendry_Mason_HW3
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:sp21masonhendryhw3.database.windows.net,1433;Initial Catalog=sp21MasonHendryHW3;Persist Security Info=False;User ID=MISAdmin;Password=Password123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
